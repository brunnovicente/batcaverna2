...
<div class="container mx-auto">
    <nav class="navbar navbar-light bg-light">
        <h4><i class="fa-solid fa-person-shelter"></i><?= __(' Editar de Monitoria') ?></h4>
    ...
    <div class="row shadow p-2">
        ...
        <div class="row">
            <div class="col">
                <?= $this->Form->control('professores_id', ['label'=>'SUPERVISOR','class'=>'form-select mb-3', 'options' => $professores, 'empty' => true])?>
            </div>
        </div>
